          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-24 items-stretch">
            {sponsorPackages.map((pkg, idx) => (
              ...
              >
                ...
                <button 
                  className={`w-full py-4 font-header text-xl uppercase tracking-widest transition-all rounded-lg focus:outline-none focus:ring-4 focus:ring-gold/50 ${
                    pkg.featured 
              ...
              <div className="grid grid-cols-2 gap-4">
                {amounts.map((amt) => (
                  <button 
                    ...
                    className={`py-4 border-2 font-header text-2xl uppercase tracking-widest transition-all rounded-lg transform active:scale-95 focus:outline-none focus:ring-2 focus:ring-gold/50 ${
                      selectedAmount === amt 
