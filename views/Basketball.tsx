    ...
    <div className="bg-white">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden bg-navy">
        ...
        <div className="container-custom relative z-10 text-center animate-fade-in">
          <h1 className="displayHeadline text-white text-7xl md:text-[12rem] mb-10">
            The <span className="text-gold">Lab</span>
          </h1>
          <p className="s3-type-premium s3-hero-subcopy text-white/80 text-xl md:text-3xl font-medium max-w-2xl mx-auto mb-14 leading-tight italic">
